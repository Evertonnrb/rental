...
public class Program {
    public static void main(String[] args) throws ParseException {
        ...
        AluguelDoCarro aluguelDoCarro = new AluguelDoCarro(dataLocacao,dataDevolucao,new Carro(modelo,placa));
        ...
        AluguelDeCarroService aluguelDeCarroService = new
                AluguelDeCarroService(valorDoAluguelPorHora,valorDoAluguelPorDia,new MSImpostoService());
